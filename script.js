...
const CONFIG_BP = {
  ...
  // テキスト＆その他
  name:       {x: 475, y: 56, w: 1150, h: 120}, // 左寄せ 白
  playerId:   {x: 1140, y: 67, w: 374, h: 66}, // 左寄せ 白
  like:       {x: 1600, y: 67, w: 250, h: 66}, // 左寄せ 白

  playTime:   {x: 475, y: 588, w: 579, h: 66}, // 左寄せ 白
  freeComment:{x: 1140, y: 588, w: 579, h: 180}, // 左寄せ 黒

  rank:       {x: 78,  y: 676, w: 250, h: 54}, // 右寄せ 黒
  score:      {x: 78,  y: 733,  w: 374, h: 66}, // 右寄せ 黒

  className:  {x: 78,  y: 926,  w: 374, h: 54}, // 中央 白
  classIcon:  {x: 84,  y: 815,  w: 218, h: 218}, // アイコン 白

  level:      {x: 78,  y: 984,  w: 250, h: 66}, // 右寄せ 白（"Lv."付き）

  guild:      {x: 475, y: 796, w: 579, h: 84}, // 左寄せ 黒
  playStyle:  {x: 1140, y: 796, w: 579, h: 84}, // 左寄せ 黒
